...
extern class SpriteBatch extends Drawable {
	...
	function addLayer(layerindex:Float, quad:Quad, transform:Transform):Float;
	...
	function setLayer(spriteindex:Float, layerindex:Float, quad:Quad, transform:Transform):Void;
...
extern class Texture extends Drawable {
	...
	function getMipmapFilter():MipmapFilter;

	function getPixelDimensions():PixelDimensions;
...
extern class Text extends Drawable {
	...
	@:overload(function ():Dimensions {})
	function getDimensions(index:Float):Dimensions;
...
extern class ParticleSystem extends Drawable {
	...
	function getEmissionArea():EmissionArea;
	...
	function getLinearAcceleration():LinearAcceleration;

	function getLinearDamping():LinearDamping;

	function getOffset():Offset;

	function getParticleLifetime():ParticleLifetime;

	function getPosition():Position;

	function getQuads():Table<Dynamic,Dynamic>;

	function getRadialAcceleration():RadialAcceleration;
	...
	function getTangentialAcceleration():TangentialAcceleration;
...
extern class Mesh extends Drawable {
	...
	function getDrawRange():DrawRange;

	function getTexture():Texture;

	@:overload(function (index:Float):Vertex {})
	function getVertex(index:Float):Vertex;

	function getVertexAttribute(vertexindex:Float, attributeindex:Float):VertexAttribute;
...
extern class GraphicsModule {
	...
	@:overload(function (gles:Bool, code:String):ValidateShaderResult {})
...
extern class Font extends Object {
	...
	function getWrap(text:String, wraplimit:Float):Wrap;
...
extern class Quad extends Object {
	...
	function getTextureDimensions():TextureDimensions;
