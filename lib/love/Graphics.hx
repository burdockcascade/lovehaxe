...
extern class Shader extends Object {
	...
	public static function send(name:String, number:Float, ...varargs:Float):Void;
	public static function send(name:String, vector:Table<Dynamic,Dynamic>, ...varargs:Table<Dynamic,Dynamic>):Void;
	public static function send(name:String, matrix:Table<Dynamic,Dynamic>, ...varargs:Table<Dynamic,Dynamic>):Void;
	public static function send(name:String, texture:Texture):Void;
	public static function send(name:String, boolean:Bool, ...varargs:Bool):Void;
	public static function send(name:String, matrixlayout:MatrixLayout, matrix:Table<Dynamic,Dynamic>, ...varargs:Table<Dynamic,Dynamic>):Void;
	...
	public static function sendColor(name:String, color:Table<Dynamic,Dynamic>, ...varargs:Table<Dynamic,Dynamic>):Void;
}
...
extern class Mesh extends Drawable {
	...
	public static function setVertex(index:Float, attributecomponent:Float, ...varargs:Float):Void;
	...
	public static function setVertex(index:Float, vertex:Table<Dynamic,Dynamic>):Void;
	public static function setVertexAttribute(vertexindex:Float, attributeindex:Float, value1:Float, value2:Float, ...varargs:Float):Void;
...
extern class GraphicsModule {
	...
	public static function clear(color:Table<Dynamic,Dynamic>, ...varargs:Table<Dynamic,Dynamic>, clearstencil:Bool, cleardepth:Bool):Void;
	...
	public static function line(x1:Float, y1:Float, x2:Float, y2:Float, ...varargs:Float):Void;
	...
	public static function points(x:Float, y:Float, ...varargs:Float):Void;
	public static function points(points:Table<Dynamic,Dynamic>):Void;
	public static function points(points:Table<Dynamic,Dynamic>):Void;
	public static function polygon(mode:DrawMode, ...varargs:Float):Void;
	...
	public static function setCanvas(canvas1:Canvas, canvas2:Canvas, ...varargs:Canvas):Void;
...
extern class Font extends Object {
	...
	public static function setFallbacks(fallbackfont1:Font, ...varargs:Font):Void;
	public static function setFilter(min:FilterMode, mag:FilterMode, anisotropy:Float):Void;
