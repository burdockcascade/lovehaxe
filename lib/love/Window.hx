...
extern class Window {
	...
	public static function getFullscreenModes(displayindex:Float):Dynamic;
	...
	public static function setMode(width:Float, height:Float, flags:Dynamic):Bool;
	...
	public static function showMessageBox(title:String, message:String, buttonlist:Dynamic, type:MessageBoxType, attachtowindow:Bool):Float;

	public static function toPixels(value:Float):Float;

	public static function toPixels(x:Float, y:Float):ToPixelsResult;

	public static function updateMode(width:Float, height:Float, settings:Dynamic):Bool;
