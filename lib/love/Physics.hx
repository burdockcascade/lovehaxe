...
extern class Body extends Object {
	...
	public static function getLocalPoints(x1:Float, y1:Float, x2:Float, y2:Float, ...varargs:Float):LocalPoints;
...
extern class Fixture extends Object {
	...
	public static function setCategory(...varargs:Float):Void;
	...
	public static function setMask(...varargs:Float):Void;
	public static function setRestitution(restitution:Float):Void;
...
extern class PhysicsModule {
	...
	public static function newChainShape(loop:Bool, x1:Float, y1:Float, x2:Float, y2:Float, ...varargs:Float):ChainShape;
	...
	public static function newPolygonShape(x1:Float, y1:Float, x2:Float, y2:Float, x3:Float, y3:Float, ...varargs:Float):PolygonShape;
