...
extern class Shape extends Object {
	public static function computeAABB(tx:Float, ty:Float, tr:Float, childIndex:Float = 1):ComputeAABBResult;
	...
	public static function rayCast(x1:Float, y1:Float, x2:Float, y2:Float, maxFraction:Float, tx:Float, ty:Float, tr:Float, childIndex:Float = 1):RayCastResult;
...
extern class Fixture extends Object {
	...
	public static function rayCast(x1:Float, y1:Float, x2:Float, y2:Float, maxFraction:Float, childIndex:Float = 1):RayCastResult;
...
extern class World extends Object {
	...
	public static function setCallbacks(beginContact:Function, endContact:Function, preSolve:Function = Null, postSolve:Function = Null):Void;
