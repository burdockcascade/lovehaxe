...
extern class Audio {
	...
	public static function getActiveEffects():Dynamic;
	...
	public static function getEffect(name:String):Dynamic;
	...
	public static function getRecordingDevices():Dynamic;
	...
	public static function pause():Dynamic;

	public static function pause(source:Source, ...:Source):Void;

	public static function pause(sources:Dynamic):Void;

	public static function play(source:Source):Void;

	public static function play(sources:Dynamic):Void;
	...
	public static function setEffect(name:String, settings:Dynamic):Bool;
	...
	public static function stop(sources:Dynamic):Void;
...
extern class Source {
	...
	public static function getEffect(name:String, filtersettings:Dynamic):Dynamic;

	public static function getFilter():Dynamic;
	...
	public static function setEffect(name:String, filtersettings:Dynamic):Bool;

	public static function setFilter(settings:Dynamic):Bool;
