...
extern class Filesystem {
	public static function append(name:String, data:String, size:Float = All):AppendResult;
	...
	public static function getInfo(path:String, filtertype:FileType = Null):Table<Dynamic,Dynamic>;
	...
	public static function read(name:String, size:Float = All):ReadResult;
	...
	public static function write(name:String, data:String, size:Float = All):WriteResult;
}
...
extern class File extends Object {
	...
	public static function read(bytes:Float = All):ReadResult;
	public static function seek(pos:Float):Bool;
	public static function setBuffer(mode:BufferMode, size:Float = 0):SetBufferResult;
	public static function tell():Float;
	public static function write(data:String, size:Float = All):WriteResult;
}
