...
extern class ImageData extends Data {
	...
	@:overload(function (format:ImageFormat, filename:String):FileData {})
	@:overload(function (outFile:String):Void {})
	function encode(outFile:String, format:ImageFormat):Void;

	function getDimensions():Dimensions;

	function getHeight():Float;

	function getPixel(x:Float, y:Float):Pixel;
...
extern class CompressedImageData extends Data {
	...
	function getDimensions(level:Float):Dimensions;

	function getFormat():CompressedImageFormat;
