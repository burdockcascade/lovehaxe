...
_hxClasses["love.PowerState"] = { __ename__ = true, __constructs__ = _hx_tab_array({[0]="Unknown","Battery","Nobattery","Charging","Charged"},5)}
__love_PowerState = _hxClasses["love.PowerState"];
__love_PowerState.Unknown = _hx_tab_array({[0]="Unknown",0,__enum__ = __love_PowerState},2)

__love_PowerState.Battery = _hx_tab_array({[0]="Battery",1,__enum__ = __love_PowerState},2)

__love_PowerState.Nobattery = _hx_tab_array({[0]="Nobattery",2,__enum__ = __love_PowerState},2)

__love_PowerState.Charging = _hx_tab_array({[0]="Charging",3,__enum__ = __love_PowerState},2)

__love_PowerState.Charged = _hx_tab_array({[0]="Charged",4,__enum__ = __love_PowerState},2)
