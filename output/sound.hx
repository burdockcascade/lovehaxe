...
extern class Sound {
	...
	@:overload
	public static function newDecoder(file:Dynamic, buffer:Float = 2048): Dynamic;

	@:overload
	public static function newDecoder(filename:String, buffer:Float = 2048): Dynamic;
	...
	@:overload
	public static function newSoundData(samples:Float, rate:Float = 44100, bits:Float = 16, channels:Float = 2): Dynamic;
