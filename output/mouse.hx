...
extern class Mouse {
	...
	@:overload
	public static function newCursor(imageData:Dynamic, hotx:Float = Dynamic, hoty:Float = Dynamic): Dynamic;

	@:overload
	public static function newCursor(filename:String, hotx:Float = Dynamic, hoty:Float = Dynamic): Dynamic;

	@:overload
	public static function newCursor(fileData:Dynamic, hotx:Float = Dynamic, hoty:Float = Dynamic): Dynamic;
