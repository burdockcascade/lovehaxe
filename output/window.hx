...
extern class Window {
	...
	public static function getDisplayOrientation(displayindex:Float = nil): Dynamic;
	...
	@:overload
	public static function showMessageBox(title:String, message:String, type:Dynamic = 'info', attachtowindow:Bool = true): Bool;

	@:overload
	public static function showMessageBox(title:String, message:String, buttonlist:Table<Dynamic,Dynamic>, type:Dynamic = 'info', attachtowindow:Bool = true): Float;
