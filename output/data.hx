...
extern class Data {
	...
	@:overload
	public static function compress(container:Dynamic, format:Dynamic, rawstring:String, level:Float = -1): Dynamic;

	@:overload
	public static function compress(container:Dynamic, format:Dynamic, data:Dynamic, level:Float = -1): Dynamic;
	...
	@:overload
	public static function encode(container:Dynamic, format:Dynamic, sourceString:String, linelength:Float = 0): Dynamic;

	@:overload
	public static function encode(container:Dynamic, format:Dynamic, sourceData:Dynamic, linelength:Float = 0): Dynamic;
	...
	@:overload
	public static function newByteData(Data:Dynamic, offset:Float = 0, size:Float = data:getSize()): Dynamic;
	...
	@:overload
	public static function unpack(format:String, data:Dynamic, pos:Float = 1): Unpack;
