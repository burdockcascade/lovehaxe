...
extern class Math {
	...
	public static function colorFromBytes(rb:Float, gb:Float, bb:Float, ab:Float = null): ColorFromBytes;

	public static function colorToBytes(r:Float, g:Float, b:Float, a:Float = null): ColorToBytes;
