...
extern class Math {
	...
	@:overload
	public static function compress(rawstring:String, format:Dynamic = 'lz4', level:Float = -1): Dynamic;

	@:overload
	public static function compress(data:Dynamic, format:Dynamic = 'lz4', level:Float = -1): Dynamic;
	...
	@:overload
	public static function newTransform(x:Float, y:Float, angle:Float = 0, sx:Float = 1, sy:Float = sx, ox:Float = 0, oy:Float = 0, kx:Float = 0, ky:Float = 0): Dynamic;
...
extern class Transform extends Object {
	...
	public static function scale(sx:Float, sy:Float = sx): Dynamic;
	...
	public static function setTransformation(x:Float, y:Float, angle:Float = 0, sx:Float = 1, sy:Float = sx, ox:Float = 0, oy:Float = 0, kx:Float = 0, ky:Float = 0): Dynamic;
