...
extern class Physics {
	...
	public static function newBody(world:Dynamic, x:Float = 0, y:Float = 0, type:Dynamic = 'static'): Dynamic;
	...
	public static function newDistanceJoint(body1:Dynamic, body2:Dynamic, x1:Float, y1:Float, x2:Float, y2:Float, collideConnected:Bool = false): Dynamic;

	public static function newEdgeShape(x1:Float, y1:Float, x2:Float, y2:Float): Dynamic;

	public static function newFixture(body:Dynamic, shape:Dynamic, density:Float = 1): Dynamic;

	@:overload
	public static function newFrictionJoint(body1:Dynamic, body2:Dynamic, x:Float, y:Float, collideConnected:Bool = false): Dynamic;

	@:overload
	public static function newFrictionJoint(body1:Dynamic, body2:Dynamic, x1:Float, y1:Float, x2:Float, y2:Float, collideConnected:Bool = false): Dynamic;

	public static function newGearJoint(joint1:Dynamic, joint2:Dynamic, ratio:Float = 1, collideConnected:Bool = false): Dynamic;

	@:overload
	public static function newMotorJoint(body1:Dynamic, body2:Dynamic, correctionFactor:Float = 0.3): Dynamic;

	@:overload
	public static function newMotorJoint(body1:Dynamic, body2:Dynamic, correctionFactor:Float = 0.3, collideConnected:Bool = false): Dynamic;
	...
	@:overload
	public static function newPrismaticJoint(body1:Dynamic, body2:Dynamic, x:Float, y:Float, ax:Float, ay:Float, collideConnected:Bool = false): Dynamic;

	@:overload
	public static function newPrismaticJoint(body1:Dynamic, body2:Dynamic, x1:Float, y1:Float, x2:Float, y2:Float, ax:Float, ay:Float, collideConnected:Bool = false): Dynamic;

	@:overload
	public static function newPrismaticJoint(body1:Dynamic, body2:Dynamic, x1:Float, y1:Float, x2:Float, y2:Float, ax:Float, ay:Float, collideConnected:Bool = false, referenceAngle:Float = 0): Dynamic;

	public static function newPulleyJoint(body1:Dynamic, body2:Dynamic, gx1:Float, gy1:Float, gx2:Float, gy2:Float, x1:Float, y1:Float, x2:Float, y2:Float, ratio:Float = 1, collideConnected:Bool = true): Dynamic;

	@:overload
	public static function newRectangleShape(width:Float, height:Float): Dynamic;

	@:overload
	public static function newRectangleShape(x:Float, y:Float, width:Float, height:Float, angle:Float = 0): Dynamic;

	@:overload
	public static function newRevoluteJoint(body1:Dynamic, body2:Dynamic, x:Float, y:Float, collideConnected:Bool = false): Dynamic;

	@:overload
	public static function newRevoluteJoint(body1:Dynamic, body2:Dynamic, x1:Float, y1:Float, x2:Float, y2:Float, collideConnected:Bool = false, referenceAngle:Float = 0): Dynamic;

	public static function newRopeJoint(body1:Dynamic, body2:Dynamic, x1:Float, y1:Float, x2:Float, y2:Float, maxLength:Float, collideConnected:Bool = false): Dynamic;

	@:overload
	public static function newWeldJoint(body1:Dynamic, body2:Dynamic, x:Float, y:Float, collideConnected:Bool = false): Dynamic;

	@:overload
	public static function newWeldJoint(body1:Dynamic, body2:Dynamic, x1:Float, y1:Float, x2:Float, y2:Float, collideConnected:Bool = false): Dynamic;

	@:overload
	public static function newWeldJoint(body1:Dynamic, body2:Dynamic, x1:Float, y1:Float, x2:Float, y2:Float, collideConnected:Bool = false, referenceAngle:Float = 0): Dynamic;

	@:overload
	public static function newWheelJoint(body1:Dynamic, body2:Dynamic, x:Float, y:Float, ax:Float, ay:Float, collideConnected:Bool = false): Dynamic;

	@:overload
	public static function newWheelJoint(body1:Dynamic, body2:Dynamic, x1:Float, y1:Float, x2:Float, y2:Float, ax:Float, ay:Float, collideConnected:Bool = false): Dynamic;

	public static function newWorld(xg:Float = 0, yg:Float = 0, sleep:Bool = true): Dynamic;
