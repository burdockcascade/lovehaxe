...
extern class Physics {
	...
	public static function getDistance(fixture1:Dynamic, fixture2:Dynamic): DistanceResult;
...
extern public class DistanceResult {
...
extern class Body extends Object {
	...
	public static function getLinearVelocity(): LinearVelocityResult;

	public static function getLinearVelocityFromLocalPoint(x:Float, y:Float): LinearVelocityFromLocalPointResult;

	public static function getLinearVelocityFromWorldPoint(x:Float, y:Float): LinearVelocityFromWorldPointResult;

	public static function getLocalCenter(): LocalCenterResult;

	public static function getLocalPoint(worldX:Float, worldY:Float): LocalPointResult;

	public static function getLocalPoints(x1:Float, y1:Float, x2:Float, y2:Float, ...:Float): LocalPointsResult;

	public static function getLocalVector(worldX:Float, worldY:Float): LocalVectorResult;

	public static function getMass(): Float;

	public static function getMassData(): MassDataResult;

	public static function getPosition(): PositionResult;

	public static function getTransform(): TransformResult;
	...
	public static function getWorldCenter(): WorldCenterResult;

	public static function getWorldPoint(localX:Float, localY:Float): WorldPointResult;

	public static function getWorldPoints(x1:Float, y1:Float, x2:Float, y2:Float): WorldPointsResult;

	public static function getWorldVector(localX:Float, localY:Float): WorldVectorResult;
...
extern class ChainShape extends Shape {
	...
	public static function getNextVertex(): NextVertexResult;

	public static function getPoint(index:Float): PointResult;

	public static function getPoints(): PointsResult;

	public static function getPreviousVertex(): PreviousVertexResult;
...
extern class CircleShape extends Shape {
	...
	public static function getPoint(): PointResult;
...
extern class Contact extends Object {
	...
	public static function getChildren(): ChildrenResult;

	public static function getFixtures(): FixturesResult;

	public static function getFriction(): Float;

	public static function getNormal(): NormalResult;

	public static function getPositions(): PositionsResult;
...
extern class Fixture extends Object {
	...
	public static function getBoundingBox(index:Float = Dynamic): BoundingBoxResult;

	public static function getCategory(): Float;

	public static function getDensity(): Float;

	public static function getFilterData(): FilterDataResult;
	...
	public static function rayCast(x1:Float, y1:Float, x2:Float, y2:Float, maxFraction:Float, childIndex:Float = Dynamic): RayCastResult;
...
extern class GearJoint extends Joint {
	...
	public static function getJoints(): JointsResult;
...
extern class Joint extends Object {
	...
	public static function getAnchors(): AnchorsResult;

	public static function getBodies(): BodiesResult;

	public static function getCollideConnected(): Bool;

	public static function getReactionForce(x:Float): ReactionForceResult;
...
extern class MotorJoint extends Joint {
	...
	public static function getLinearOffset(): LinearOffsetResult;
...
extern class MouseJoint extends Joint {
	...
	public static function getTarget(): TargetResult;
...
extern class PulleyJoint extends Joint {
	...
	public static function getGroundAnchors(): GroundAnchorsResult;

	public static function getLengthA(): Float;

	public static function getLengthB(): Float;

	public static function getMaxLengths(): MaxLengthsResult;
...
extern class Shape extends Object {
	...
	public static function computeAABB(tx:Float, ty:Float, tr:Float, childIndex:Float = Dynamic): ComputeAABBResult;
	...
	public static function rayCast(x1:Float, y1:Float, x2:Float, y2:Float, maxFraction:Float, tx:Float, ty:Float, tr:Float, childIndex:Float = Dynamic): RayCastResult;
...
extern class World extends Object {
	...
	public static function getCallbacks(): CallbacksResult;
	...
	public static function getGravity(): GravityResult;
