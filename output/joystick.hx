...
extern class Joystick extends Object {
	...
	public static function getAxes(): AxesResult;
	...
	public static function getDeviceInfo(): DeviceInfoResult;
	...
	@:overload
	public static function getGamepadMapping(axis:Dynamic): GamepadMappingResult;

	@:overload
	public static function getGamepadMapping(button:Dynamic): GamepadMappingResult;
	...
	public static function getID(): IDResult;

	public static function getName(): String;

	public static function getVibration(): VibrationResult;
