...
extern class Joystick {
	...
	@:overload
	public static function setGamepadMapping(guid:String, button:Dynamic, inputtype:Dynamic, inputindex:Float, hatdir:Dynamic = nil): Bool;

	@:overload
	public static function setGamepadMapping(guid:String, axis:Dynamic, inputtype:Dynamic, inputindex:Float, hatdir:Dynamic = nil): Bool;
