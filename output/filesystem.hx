...
extern class Filesystem {
	...
	@:overload
	public static function append(name:String, data:Dynamic, size:Float = all): Append;
	...
	@:overload
	public static function getInfo(path:String, filtertype:Dynamic = nil): Table<Dynamic,Dynamic>;
	...
	@:overload
	public static function mount(filedata:Dynamic, mountpoint:String, appendToPath:Bool = false): Bool;

	@:overload
	public static function mount(data:Dynamic, archivename:String, mountpoint:String, appendToPath:Bool = false): Bool;
	...
	@:overload
	public static function read(container:Dynamic, name:String, size:Float = all): Read;
	...
	@:overload
	public static function write(name:String, data:Dynamic, size:Float = all): Write;
...
extern class File extends Object {
	...
	@:overload
	public static function read(container:Dynamic, bytes:Float = all): Read;

	public static function seek(pos:Float): Bool;

	public static function setBuffer(mode:Dynamic, size:Float = 0): SetBuffer;
	...
	@:overload
	public static function write(data:Dynamic, size:Float = all): Write;
